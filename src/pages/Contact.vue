                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                <div class="form-floating">
                                    <input class="form-control" id="name" type="text" placeholder="Enter your name..."
                                           data-sb-validations="required" v-model="user.name"/>
                                ...
                                <!-- Submit Button-->
                                <button class="btn btn-primary text-uppercase" id="submitButton" type="submit" @click="submit">
                                    Send
                                </button>
                            </form>
                        </div>
...
export default {
    ...
    methods: {
        async submit(e){
            ...
            try{
                const res = await Axios.post(`${this.URL}/contacts`, data)
                alert('发送成功！')
                this.user = {
                    name: '',
                    email: '',
